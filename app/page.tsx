          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 text-center lg:text-left">
              ...
              <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                ...
                learners worldwide and accelerate your career path today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button
                  size="lg"
                  className="h-14 px-8 text-lg rounded-xl shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
                  asChild
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 px-8 text-lg rounded-xl backdrop-blur-sm border-primary/20 hover:bg-primary/5 transition-all duration-300"
                  asChild
                >
              ...
              <div className="flex items-center gap-8 justify-center lg:justify-start pt-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-background bg-muted overflow-hidden flex items-center justify-center"
                    >
            ...
            <div className="relative animate-in zoom-in-95 duration-1000 hidden lg:block">
              ...
              <div className="relative rounded-3xl border border-primary/10 shadow-2xl overflow-hidden bg-muted/20 backdrop-blur-xl aspect-[4/3]">
                <Image
                  src="/image/courses/NextjsMasterClass.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-muted-foreground text-xl max-w-2xl mx-auto leading-relaxed">
              We provide a comprehensive learning ecosystem designed for impact
              and career growth.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: BookOpen,
                desc: "Access a wide range of courses across multiple disciplines and skill levels",
              },
              {
              ...
              },
              {
                ...
                icon: Clock,
                desc: "Study whenever and wherever you want with lifetime access to courses",
              },
              {
                title: "Earn Certificates",
                icon: Award,
                desc: "Receive verified certificates upon completion to showcase your achievements",
              },
            ].map((f, i) => (
              <div
                key={i}
                className="group p-8 rounded-3xl bg-muted/30 border border-transparent hover:border-primary/10 hover:bg-background hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="text-muted-foreground text-lg max-w-xl">
                Start your journey with our most-enrolled and highly-rated
                curriculum.
              </p>
            </div>
            <Button
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {dbCourses.map((course) => (
              <Card
                key={course.id}
                className="group overflow-hidden border-primary/5 rounded-3xl hover:shadow-2xl transition-all duration-500 bg-background/50 backdrop-blur-sm"
              >
                ...
                <CardContent>
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    ...
                    <Button
                      variant="ghost"
                      className="rounded-xl group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300"
                      asChild
                    >
                      <Link
                        href={session ? `/courses/${course.id}` : "/signup"}
                      >
            ...
            {[
              {
                ...
                content:
                  "The courses are incredibly well-structured. I went from zero to land my first dev job in just 6 months!",
              ...
              },
              {
                ...
                role: "Data Analyst",
                content:
                  "The flexibility is unmatched. I could balance my full-time job and my learning without any stress.",
              ...
              },
              {
                ...
                content:
                  "Practical, real-world examples that I could apply immediately at my workplace. Highly recommended!",
                image: "/images/testimonials/avatar3.jpg",
              },
            ].map((t, i) => (
              <div
                key={i}
                className="p-8 rounded-3xl bg-muted/30 border border-primary/5 relative"
              >
                ...
                <p className="text-lg italic text-foreground mb-8">
                  "{t.content}"
                </p>
                <div className="flex items-center gap-4">
        ...
        <div className="max-w-5xl mx-auto relative group">
          ...
          <div className="relative bg-foreground rounded-[3rem] p-12 md:p-20 text-center text-background overflow-hidden">
            ...
            <p className="text-xl mb-12 opacity-80 max-w-2xl mx-auto leading-relaxed">
              Join the future of education. Get unlimited access to premium
              courses today.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Button
                size="lg"
                variant="secondary"
                className="h-16 px-10 text-xl rounded-2xl border-white/20 hover:bg-white/5"
                asChild
              >
