// app/student-dashboard/certificates/[certificateId]/certificate-actions-client.tsx
"use client";
...
interface CertificateActionsClientProps {
  certificate: {
    id: string;
...
export function CertificateActionsClient({
  certificate,
  fullName,
  issuedDate,
}: CertificateActionsClientProps) {
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="w-full" asChild>
                  <Link
                    href={`/verify?certificateId=${certificate.certificateId}`}
                    target="_blank"
                  >
